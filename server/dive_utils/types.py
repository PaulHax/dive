...
class PipelineJob(TypedDict):
    ...
    # The dataset's frame metadata file handed to opt-in pipelines. The item id
    # points at a frame-metadata sidecar item in the dataset folder; the key is the
    # KWIVER config target declared by the pipe's `# Metadata File:` header.
